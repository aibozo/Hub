...
pub fn resolve(ev: KeyEvent) -> Hotkey {
    ...
    match (m, ev.code) {
        ...
        (KeyModifiers::CONTROL, KeyCode::Char('b')) => Hotkey::AgentsPauseResume,
        (KeyModifiers::CONTROL, KeyCode::Char('a')) => Hotkey::AgentsNew,
        (KeyModifiers::CONTROL, KeyCode::Char('u')) => Hotkey::AgentsReplan,
